...
${OBJECTDIR}/azbduobt.o: azbduobt.cc nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall `pkg-config --cflags libusb-1.0` `pkg-config --cflags glib-2.0` `pkg-config --cflags dbus-1` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/azbduobt.o azbduobt.cc

${OBJECTDIR}/btraw.o: btraw.cc nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall `pkg-config --cflags libusb-1.0` `pkg-config --cflags glib-2.0` `pkg-config --cflags dbus-1` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/btraw.o btraw.cc

${OBJECTDIR}/main.o: main.cc nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall `pkg-config --cflags libusb-1.0` `pkg-config --cflags glib-2.0` `pkg-config --cflags dbus-1` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cc
